...
{
    public partial class DotnetCoreDBContext : DbContext
    {
        public DotnetCoreDBContext()
        {
        }

        public DotnetCoreDBContext(DbContextOptions<DotnetCoreDBContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Name=DotnetCoreDB");
            }
        }
